...
{
    [XyzResourceType("pulumi-package:index:StaticPage")]
    public partial class StaticPage : Pulumi.ComponentResource
    {
        ...
        public StaticPage(string name, StaticPageArgs args, ComponentResourceOptions? options = null)
            : base("pulumi-package:index:StaticPage", name, args ?? new StaticPageArgs(), MakeResourceOptions(options, ""), remote: true)
        {
        }
