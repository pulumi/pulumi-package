...
namespace Pulumi.Pulumipackage
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Pulumipackage.version.txt");
    ...
    internal sealed class PulumipackageResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public PulumipackageResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
